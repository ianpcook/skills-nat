...
const ClawdbotIcon = () => (
  <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
    ...
    {/* Left claw */}
    <path
      d="M3 6C3 6 1 4 2 3C3 2 5 3 5 3L6 5C6 5 4 5 3 6Z"
      fill="#DC2626"
    />
    <path
      d="M6 5L6 9"
    ...
    {/* Right claw */}
    <path
      d="M17 6C17 6 19 4 18 3C17 2 15 3 15 3L14 5C14 5 16 5 17 6Z"
      fill="#DC2626"
    />
    <path
      d="M14 5L14 9"
...
const GeminiIcon = () => (
  <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
    <path
      d="M10 2C10 2 10 10 10 10C10 10 2 10 2 10C2 10 10 10 10 10C10 10 10 18 10 18"
      stroke="#4285F4"
      strokeWidth="2"
      strokeLinecap="round"
    />
    <path
      d="M10 2C10 2 10 10 10 10C10 10 18 10 18 10C18 10 10 10 10 10C10 10 10 18 10 18"
      stroke="#EA4335"
      strokeWidth="2"
      strokeLinecap="round"
    />
  ...
  return (
    <section className="px-6 py-10">
      <div className="container mx-auto">
        <p className="mb-6 text-center label-text">
